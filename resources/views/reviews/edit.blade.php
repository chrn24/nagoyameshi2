...
<div class="container">
    <br>
    <h2 class="text-center display-6 mb-4"><strong>レビュー編集</strong></h2>

    <div class="row justify-content-center">
        <div class="col-md-6">
            <form action="{{ route('reviews.update.confirm') }}" method="POST" class="p-4 border rounded bg-light shadow-sm">
                @csrf
